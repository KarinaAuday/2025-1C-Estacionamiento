        ...
        public IActionResult Create(int? id)
        {
            if (id.HasValue)
            {
                ...
                if (persona != null)
                {
                    ...
                    ViewBag.PersonaCrearId = persona.Id;
            ...
            public async Task<IActionResult> Create([Bind("Id,Calle,Altura,CodigoPostal,Localidad,Provincia,PersonaId")] Direccion direccion)
            {
            ...
            [HttpPost]
            [ValidateAntiForgeryToken]
            public async Task<IActionResult> Edit(int id, [Bind("Id,Calle,Altura,CodigoPostal,Localidad,Provincia,PersonaId")] Direccion direccion)
            {
                if (id != direccion.Id)
                {
                    return NotFound();
